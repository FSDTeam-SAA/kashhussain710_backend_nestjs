...
export type VehicleReportDocument = HydratedDocument<VehicleReport>;
...
export class VehicleReport {
  ...
  @Prop({ default: 'free' })
  reportType: string; // 'free' or 'paid'
...
export const VehicleReportSchema = SchemaFactory.createForClass(VehicleReport);
