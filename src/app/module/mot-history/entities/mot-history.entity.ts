...
export class MotHistory {
  ...
  @Prop() latestTestResult?: string;
  @Prop() latestExpiryDate?: string;
  @Prop() isMotValid?: boolean;

  // ✅ Mileage
  @Prop({ type: [MileageRecord], default: [] })
  mileageHistory?: MileageRecord[];

  @Prop() lastMileage?: number;
  @Prop() lastMileageUnit?: string;
  @Prop() averageMileagePerYear?: number;
